...
const file_auth_v2_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v2/auth.proto\x12\aauth.v1\"Y\n" +
	...
	"\x04user\x18\x03 \x01(\v2\r.auth.v1.UserR\x04user\"\x84\x01\n" +
	"\x04User\x12\x17\n" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\tR\tcreatedAt2\xca\x01\n" +
	"\vAuthService\x12E\n" +
	"\n" +
	"CreateUser\x12\x1a.auth.v1.CreateUserRequest\x1a\x1b.auth.v1.CreateUserResponse\x12<\n" +
	"\aGetUser\x12\x17.auth.v1.GetUserRequest\x1a\x18.auth.v1.GetUserResponse\x126\n" +
	"\x05Login\x12\x15.auth.v1.LoginRequest\x1a\x16.auth.v1.LoginResponseB1Z/github.com/Sergey-1214/contracts/auth/v1;authv1b\x06proto3"
...
var file_auth_v2_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_auth_v2_auth_proto_depIdxs = []int32{
	6, // 0: auth.v1.CreateUserResponse.user:type_name -> auth.v1.User
	6, // 1: auth.v1.GetUserResponse.user:type_name -> auth.v1.User
	6, // 2: auth.v1.LoginResponse.user:type_name -> auth.v1.User
	0, // 3: auth.v1.AuthService.CreateUser:input_type -> auth.v1.CreateUserRequest
	...
	1, // 6: auth.v1.AuthService.CreateUser:output_type -> auth.v1.CreateUserResponse
	3, // 7: auth.v1.AuthService.GetUser:output_type -> auth.v1.GetUserResponse
