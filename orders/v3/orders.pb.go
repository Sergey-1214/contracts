...
type CreateOrderResponse struct {
	...
	Status        OrderStatus            `protobuf:"varint,2,opt,name=status,proto3,enum=orders.v3.OrderStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Order struct {
	...
	Status        OrderStatus            `protobuf:"varint,3,opt,name=status,proto3,enum=orders.v3.OrderStatus" json:"status,omitempty"`
...
const file_orders_proto_rawDesc = "" +
	"\n" +
	"\forders.proto\x12\torders.v3\"b\n" +
	"\x12CreateOrderRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x123\n" +
	"\n" +
	"order_item\x18\x02 \x03(\v2\x14.orders.v3.OrderItemR\torderItem\"`\n" +
	"\x13CreateOrderResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12.\n" +
	"\x06status\x18\x02 \x01(\x0e2\x16.orders.v3.OrderStatusR\x06status\",\n" +
	"\x0fGetOrderRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\":\n" +
	"\x10GetOrderResponse\x12&\n" +
	"\x05order\x18\x01 \x01(\v2\x10.orders.v3.OrderR\x05order\"`\n" +
	"\x13UpdateStatusRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12.\n" +
	"\x06status\x18\x02 \x01(\x0e2\x16.orders.v3.OrderStatusR\x06status\"a\n" +
	...
	"\x05price\x18\x03 \x01(\x01R\x05price\"\xe4\x01\n" +
	"\x05Order\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12!\n" +
	"\ftotal_amount\x18\x02 \x01(\x01R\vtotalAmount\x12.\n" +
	"\x06status\x18\x03 \x01(\x0e2\x16.orders.v3.OrderStatusR\x06status\x12\x1d\n" +
	"\n" +
	"created_at\x18\x04 \x01(\tR\tcreatedAt\x12\x17\n" +
	"\auser_id\x18\x05 \x01(\tR\x06userId\x125\n" +
	"\vorder_items\x18\x06 \x03(\v2\x14.orders.v3.OrderItemR\n" +
	"orderItems*\xb6\x01\n" +
	...
	"\rOrdersService\x12L\n" +
	"\vCreateOrder\x12\x1d.orders.v3.CreateOrderRequest\x1a\x1e.orders.v3.CreateOrderResponse\x12C\n" +
	"\bGetOrder\x12\x1a.orders.v3.GetOrderRequest\x1a\x1b.orders.v3.GetOrderResponse\x12O\n" +
	"\fUpdateStatus\x12\x1e.orders.v3.UpdateStatusRequest\x1a\x1f.orders.v3.UpdateStatusResponseB5Z3github.com/Sergey-1214/contracts/orders/v3;ordersv3b\x06proto3"
...
var file_orders_proto_goTypes = []any{
	(OrderStatus)(0),             // 0: orders.v3.OrderStatus
	(*CreateOrderRequest)(nil),   // 1: orders.v3.CreateOrderRequest
	(*CreateOrderResponse)(nil),  // 2: orders.v3.CreateOrderResponse
	(*GetOrderRequest)(nil),      // 3: orders.v3.GetOrderRequest
	(*GetOrderResponse)(nil),     // 4: orders.v3.GetOrderResponse
	(*UpdateStatusRequest)(nil),  // 5: orders.v3.UpdateStatusRequest
	(*UpdateStatusResponse)(nil), // 6: orders.v3.UpdateStatusResponse
	(*OrderItem)(nil),            // 7: orders.v3.OrderItem
	(*Order)(nil),                // 8: orders.v3.Order
}
var file_orders_proto_depIdxs = []int32{
	7,  // 0: orders.v3.CreateOrderRequest.order_item:type_name -> orders.v3.OrderItem
	0,  // 1: orders.v3.CreateOrderResponse.status:type_name -> orders.v3.OrderStatus
	8,  // 2: orders.v3.GetOrderResponse.order:type_name -> orders.v3.Order
	0,  // 3: orders.v3.UpdateStatusRequest.status:type_name -> orders.v3.OrderStatus
	0,  // 4: orders.v3.UpdateStatusResponse.status:type_name -> orders.v3.OrderStatus
	0,  // 5: orders.v3.Order.status:type_name -> orders.v3.OrderStatus
	7,  // 6: orders.v3.Order.order_items:type_name -> orders.v3.OrderItem
	1,  // 7: orders.v3.OrdersService.CreateOrder:input_type -> orders.v3.CreateOrderRequest
	3,  // 8: orders.v3.OrdersService.GetOrder:input_type -> orders.v3.GetOrderRequest
	5,  // 9: orders.v3.OrdersService.UpdateStatus:input_type -> orders.v3.UpdateStatusRequest
	2,  // 10: orders.v3.OrdersService.CreateOrder:output_type -> orders.v3.CreateOrderResponse
	4,  // 11: orders.v3.OrdersService.GetOrder:output_type -> orders.v3.GetOrderResponse
	6,  // 12: orders.v3.OrdersService.UpdateStatus:output_type -> orders.v3.UpdateStatusResponse
