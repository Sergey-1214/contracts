...
const file_orders_v1_orders_proto_rawDesc = "" +
	"\n" +
	"\x16orders/v1/orders.proto\x12\torders.v1\"b\n" +
	"\x12CreateOrderRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x123\n" +
	"\n" +
	"order_item\x18\x02 \x03(\v2\x14.orders.v1.OrderItemR\torderItem\"`\n" +
	...
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12.\n" +
	"\x06status\x18\x02 \x01(\x0e2\x16.orders.v1.OrderStatusR\x06status\"a\n" +
	...
	"\x05price\x18\x03 \x01(\x01R\x05price\"\x94\x01\n" +
	"\x05Order\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12!\n" +
	"\ftotal_amount\x18\x02 \x01(\x01R\vtotalAmount\x12.\n" +
	"\x06status\x18\x03 \x01(\x0e2\x16.orders.v1.OrderStatusR\x06status\x12\x1d\n" +
	"\n" +
	"created_at\x18\x04 \x01(\tR\tcreatedAt*\xb6\x01\n" +
	...
	"\bGetOrder\x12\x1a.orders.v1.GetOrderRequest\x1a\x1b.orders.v1.GetOrderResponse\x12O\n" +
	"\fUpdateStatus\x12\x1e.orders.v1.UpdateStatusRequest\x1a\x1f.orders.v1.UpdateStatusResponseB5Z3github.com/Sergey-1214/contracts/orders/v1;ordersv1b\x06proto3"
...
var file_orders_v1_orders_proto_goTypes = []any{
	...
	(*UpdateStatusRequest)(nil),  // 5: orders.v1.UpdateStatusRequest
	(*UpdateStatusResponse)(nil), // 6: orders.v1.UpdateStatusResponse
	(*OrderItem)(nil),            // 7: orders.v1.OrderItem
	(*Order)(nil),                // 8: orders.v1.Order
}
var file_orders_v1_orders_proto_depIdxs = []int32{
	7, // 0: orders.v1.CreateOrderRequest.order_item:type_name -> orders.v1.OrderItem
	0, // 1: orders.v1.CreateOrderResponse.status:type_name -> orders.v1.OrderStatus
	8, // 2: orders.v1.GetOrderResponse.order:type_name -> orders.v1.Order
	0, // 3: orders.v1.UpdateStatusRequest.status:type_name -> orders.v1.OrderStatus
	0, // 4: orders.v1.UpdateStatusResponse.status:type_name -> orders.v1.OrderStatus
	...
	5, // 8: orders.v1.OrdersService.UpdateStatus:input_type -> orders.v1.UpdateStatusRequest
	...
	6, // 11: orders.v1.OrdersService.UpdateStatus:output_type -> orders.v1.UpdateStatusResponse
